...
| H2A-030 | Readiness recommends an autonomy ceiling but never auto-approves autonomy. | proved | tests/integration/test_assessment_state.py::test_autonomy_fact_requires_explicit_approval_asset | none |
...
| H2A-047 | Unknown states are typed and cannot silently disappear. | proved | tests/integration/test_assessment_state.py::test_draft_unknown_cannot_disappear_from_managed_gate | none |
...
| H2A-051 | Mother workspace creates a canonical child workspace with stage and owner metadata. | proved | tests/integration/test_workspace_repository.py::test_workspace_new_validates_staging_before_atomic_publication | none |
...
| H2A-064 | Stage and release gates reject missing or indeterminate evidence. | proved | tests/integration/test_build.py::test_build_rechecks_release_gate_for_a_handcrafted_plan | none |
| H2A-065 | Readiness remains separate from owner autonomy approval and supports bounded outcomes. | proved | tests/integration/test_assessment_state.py::test_matching_autonomy_approval_uses_real_evidence_without_identifier_collision | none |
...
| H2A-071 | Evidence-backed gates block promotion based only on filled documents. | proved | tests/integration/test_assessment_state.py::test_handwritten_foundry_gate_cannot_advance_empty_workspace | none |
...
| H2A-075 | Unknowns remain visible with owner, impact, restrictions, and explicit disposition. | proved | tests/integration/test_assessment_state.py::test_draft_unknown_cannot_disappear_from_managed_gate | none |
