---
name: deviation-log
description: Record implementation deviations in plan, discovery, conservative-choice, and revisit form.
---

# Outcome

Record implementation deviations in plan, discovery, conservative-choice, and revisit form.
...
For each deviation record the original plan, new discovery, conservative choice, impact, owner, evidence, and explicit revisit trigger.
