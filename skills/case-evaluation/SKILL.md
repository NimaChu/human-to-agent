...
description: Design normal, boundary, and failure cases with independent evaluators and recorded outcomes.
---

# Outcome

Design normal, boundary, and failure cases with independent evaluators and recorded outcomes.
...
Create normal, boundary, and failure cases. Define expected output and evaluator before execution. Have a verifier independent from the implementer record each result.
