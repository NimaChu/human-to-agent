...
description: Reproduce a workspace independently, challenge self-evaluation, and write a read-only verification report.
---

# Outcome

Reproduce a workspace independently, challenge self-evaluation, and write a read-only verification report.
...
Work only from recorded source assets. Run representative cases, challenge claimed acceptance, write an isolated report, and never repair the source during verification.
