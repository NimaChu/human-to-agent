---
name: stage-review
description: Assess a maturity stage from direct evidence and report gaps without editing normative assets.
---

# Outcome

Assess a maturity stage from direct evidence and report gaps without editing normative assets.
...
Load the requested AssessmentSnapshot, run the applicable gate, distinguish gap from indeterminate evidence, and issue next actions. Do not change the stage.
