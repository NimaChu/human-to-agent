...
description: Maintain source assets, references, indexes, migrations, and deterministic builds through hta transactions.
---

# Outcome

Maintain source assets, references, indexes, migrations, and deterministic builds through hta transactions.
...
Validate candidate changes, update references and artifact index atomically, record an event, verify adapters, and build twice when determinism is material.
