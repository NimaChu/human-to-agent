---
name: work-reproduction
description: Reproduce a real task case-first and record its inputs, outputs, judgments, edits, timing, and direct evidence.
---

# Outcome

Reproduce a real task case-first and record its inputs, outputs, judgments, edits, timing, and direct evidence.
...
Select one real case. Capture original inputs, outputs, chronological actions, human judgment, manual modifications, elapsed time, exceptions, and owner usability confirmation.
