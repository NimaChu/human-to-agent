---
name: task-contract
description: Turn observed work evidence into a bounded task contract without inventing business rules.
---

# Outcome

Turn observed work evidence into a bounded task contract without inventing business rules.
...
Derive goal, input/output boundaries, preconditions, steps, rules, judgment points, acceptance criteria, exceptions, prohibited actions, applicability, and ownership from recorded evidence.
