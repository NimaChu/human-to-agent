...
from human_to_agent.domain.assets import ASSET_MODELS
from human_to_agent.domain.common import AssetMetadata
from human_to_agent.domain.events import EVENT_MODELS
from human_to_agent.domain.evidence import Evidence
from human_to_agent.domain.readiness import READINESS_MODELS
from human_to_agent.domain.recertification import RECERTIFICATION_MODELS
from human_to_agent.domain.stages import STAGE_MODELS
from human_to_agent.domain.unknowns import UNKNOWN_MODELS
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Write or check Human to Agent JSON Schemas")
